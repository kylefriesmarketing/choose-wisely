...
CW.Endings = {
  ...
  END_T_BAD: { number: 2, id: "END_T_BAD", title: "Stuffed on the Shelf", category: "Bad", route: "teddy",
    ...
    clue: "Do every last thing the bear asks. The final ask is a seat." },
  END_T_FUNNY: { number: 3, id: "END_T_FUNNY", title: "Birthday Bear Boss", category: "Funny", route: "teddy",
    ...
    clue: "Give the bear exactly as bought, and let it do the talking. All of it." },
  ...
  END_C_CURSED: { number: 5, id: "END_C_CURSED", title: "Perfect Party, Empty Chair", category: "Cursed", route: "candle",
    ...
    clue: "Wish the party perfect, and see what perfection has no room for." },
  ...
  END_B_BAD: { number: 8, id: "END_B_BAD", title: "Birthday From the Moon", category: "Bad", route: "balloon",
    ...
    clue: "Cut the string while the ground is still a rumour." },
  END_B_FUNNY: { number: 9, id: "END_B_FUNNY", title: "Everyone Loves the Balloon", category: "Funny", route: "balloon",
    ...
    clue: "Arrive second. Let the balloon go through the door first." },
  ...
  END_D_BAD: { number: 11, id: "END_D_BAD", title: "Clockwork Birthday", category: "Bad", route: "dragon",
    ...
    clue: "Order the wounded thing to keep fighting, and count what starts ticking." },
  ...
  END_DISPLAY_PRISONER: { number: 13, id: "END_DISPLAY_PRISONER", title: "Display Window Prisoner", category: "Bad", route: "shop",
    ...
    clue: "Try to leave with all four gifts. The window has room for a fifth." },
  ...
  END_C_WAXWORK: { number: 19, id: "END_C_WAXWORK", title: "Waxwork", category: "Cursed", route: "candle",
    ...
    clue: "Keep wishing. Every wish is a measurement." },
  END_C_MELTED_FREE: { number: 20, id: "END_C_MELTED_FREE", title: "Melted Free", category: "Good", route: "candle",
    ...
    clue: "Spend the very last wish on a stranger made of wax." },
  ...
  END_B_ANCHORED: { number: 23, id: "END_B_ANCHORED", title: "The New Anchor", category: "Cursed", route: "balloon",
    ...
    clue: "Offer the ring your wrist, just for a moment. Moments are what it collects." },
  ...
  END_D_FOUNDRY_HALT: { number: 25, id: "END_D_FOUNDRY_HALT", title: "The Halted Foundry", category: "Secret", route: "dragon",
    ...
    clue: "One small brave thing, placed in exactly the right gears, stops the whole works." },
  ...
  END_NO_ESCAPE: { number: 28, id: "END_NO_ESCAPE", title: "The Stair Only Goes Down", category: "Nightmare", route: "cellar",
    ...
    clue: "Go down, then change your mind. Count the stairs on the way back up. Keep counting." },
  ...
  END_SHATTERED: { number: 30, id: "END_SHATTERED", title: "You Felt That", category: "Nightmare", route: "cellar",
    ...
    clue: "Break the little you, and listen for what goes out at the same instant." },
  ...
  END_THE_REGULAR: { number: 33, id: "END_THE_REGULAR", title: "The Regular", category: "Nightmare", route: "cellar",
    ...
    clue: "Ring the bell often enough, and one night the counter lifts for you." },
  ...
  END_NEW_STOCK: { number: 43, id: "END_NEW_STOCK", title: "New Stock", category: "Nightmare", route: "cellar",
    ...
    clue: "The chair in the workroom is warm. It is always warm. Sit." },
  ...
  END_MOSTLY_HERE: { number: 50, id: "END_MOSTLY_HERE", title: "Mostly Here Already", category: "Nightmare", route: "cellar",
    ...
    clue: "Most of you is already shelved in the larder. Go and lie down beside the rest." },
  ...
  END_KEPT_WARM: { number: 51, id: "END_KEPT_WARM", title: "Kept Warm", category: "Cursed", route: "shop",
    ...
    imagePrompt: "storybook illustration of a child's wrist wearing a whole bright friendship bracelet that will not come off, glowing faintly in the rain outside a little shop, handmade stop-motion felt-and-thread style",
  ...
  END_HER_NAME: { number: 52, id: "END_HER_NAME", title: "Her Name in Your Fist", category: "Good", route: "shop",
    ...
    imagePrompt: "storybook illustration of a child running out of a shop into the rain clutching a small paper name tag to their chest, warm light spilling behind them, handmade stop-motion felt-and-thread style",
  ...
  END_ON_LAYAWAY: { number: 53, id: "END_ON_LAYAWAY", title: "Paid in Advance", category: "Nightmare", route: "cellar",
    ...
    imagePrompt: "storybook illustration of a child lying very still among half-finished toys on a dim back shelf, a paper price tag tied to their wrist, handmade stop-motion felt-and-thread style",
  ...
  END_BURNED_BOOK: { number: 54, id: "END_BURNED_BOOK", title: "The Book Closed", category: "Secret", route: "meta",
    ...
    imagePrompt: "storybook illustration of a great ledger ablaze on a desk, a child stepping back into the warm firelight, a tall shopkeeper watching without moving, handmade stop-motion felt-and-thread style",
  ...
  END_EMPTY_COAT: { number: 55, id: "END_EMPTY_COAT", title: "The Keeper Who Emptied the Shop", category: "Good", route: "shop",
    ...
    imagePrompt: "storybook illustration of a child wearing a shopkeeper's coat behind a counter, empty shelves all around, children walking out into rainy dawn light, handmade stop-motion felt-and-thread style",
  ...
  END_YOUR_OWN_FACE: { number: 56, id: "END_YOUR_OWN_FACE", title: "Whose Face", category: "Nightmare", route: "cellar",
    ...
    imagePrompt: "storybook illustration of a child at a shop display window meeting their own small face pressed to the glass from the inside, rainy street reflected, handmade stop-motion felt-and-thread style",
